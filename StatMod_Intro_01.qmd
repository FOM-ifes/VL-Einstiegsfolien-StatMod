...
::: footnote
^5^ $\frac{1}{n}$ ist nicht falsch; $\frac{1}{n-1}$ ist aus Gründen, die außerhalb der Vorlesung liegen, besser, wenn von einer Stischprobe auf die Varianz der Population ($\sigma^2$) verallgemeinert werden soll. Der Unterschied ist bei großem $n$ klein.
:::
...
-   *Säulendiagramm / Balkendiagramm*: Häufigkeit con Merkmalsausprägungen (nominal, ordinal, metrisch diskret) -- `gf_bar()`
...
## Übersicht deskriptiver Kennzahlen 
