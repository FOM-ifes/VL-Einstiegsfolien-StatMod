...
-   Einstieg in die Bayessche Statistik

## Was Sie lernen 👩‍🏫

-   Sie lernen den theoretischen Hintergrund der Bayesschen Statistik kennen.

-   Sie können zwischen epistemischer und aleatorischer Wahrscheinlichkeit unterscheiden.

-   Sie wissen, was die Priori-Verteilung, die Likelihood und die Posteriori-Verteilung ist.

-   Sie kennen das Beta-Binomial-Modell und dessen Parameter.

-   Sie kennen die Beta-Verteilung und deren Momente.

-   Die können die Binomialverteilung verwenden.
...
-   **Prior-Verteilung** $Pr({\color{blue}{\pi}})$: Wahrscheinlichkeitsverteilung von $\color{blue}{\pi}$, *bevor* wir unsere Daten haben.

-   **Likelihood** $Pr({\color{green}{p}}|{\color{blue}{\pi}})$: *Mutmaßlichkeit* von $\color{green}{p}$ bei gegebenem $\color{blue}{\pi}$.

-   **Posterior-Verteilung** $Pr({\color{blue}{\pi}}|{\color{green}{p}})$: Wahrscheinlichkeitsverteilung von $\color{blue}{\pi}$ *nachdem* wir unsere Daten haben.
...
-   **Posterior-Verteilung**: Beta-Verteilung mit Parametern: $\alpha_{post}, \beta_{post}$: $$\pi|(Y=y) \sim Beta(\alpha_{post}, \beta_{post})$$ mit $$\alpha_{post} = \alpha_{prior} + y, \quad \beta_{post} = \beta_{prior} + n - y$$
...
## Prior-Verteilung: $\alpha_{prior}$ und $\beta_{prior}$ :thinking:

**Prior-Verteilung** $Pr({\color{blue}{\pi}})$:
...
## Von der Prior- zur Posterior-Verteilung: $\alpha_{post}$ und $\beta_{post}$ :thinking:

**Posterior-Verteilung** $Pr({\color{blue}{\pi}}|{\color{green}{y}})$:
...
Mit Hilfe der Posterior-Verteilung können Sie Punkt- und Intervallschätzer berechnen.
:::
...
-   **A**: Die Streuung der Posterior-Verteilung wird kleiner.

-   **B**: Die Streuung der Posterior-Verteilung wird größer.

-   **C**: Die Streuung der Posterior-Verteilung ändert sich nicht.
