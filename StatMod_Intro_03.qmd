...
-   Seien Sie offen für [neue Erkenntnisse]{.green}:
    ...
    -   Dieser Grundsatz ist Ausdruck der Bayesschen Erkenntnistheorie und verdeutlicht, dass wissenschaftliche Erkenntnisse vorläufig sind und dass Wissenschaftler:innen keine absoluten oder sicheren Aussagen aufstellen sollten.
...
-   [Alternative Erklärungen]{.green} in Betracht ziehen:
    ...
    -   Dies drückt aus, was in der Bayesschen Philosophie als das einfache Prinzip der Konditionalisierung bezeichnet wird: Wenn wir Erkenntnisse abwägen, müssen wir berücksichtigen, inwieweit sie die Bandbreite möglicher Erklärungen für die Daten unterstützt.
