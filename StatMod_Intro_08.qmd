...
:::footnote
Die Daten stammen von [Kaggle](https://www.kaggle.com/datasets/kaushiksuresh147/customer-segmentation). Im Vorhinein wurden alle Zeilen mit fehlenden Werten entfernt und der Trainings- und Testdatensatz zusammengefasst.
:::
...
Die Voreistellung für die Anzahl der Entscheidungsbäume im Modell liegt bei `ntree = 500`.
...
## Verglech der Modellgüte (I/II)

Häufig verwendete Modellgütekriterien für die Klassifikantion sind:

**Accuracy**: Ist das Verhältnis von korrekt vorhergesagten Werten zur Gesamtzahl aller Vorhersagen.
